        ...
        switch (portalBlockAxis)
        {
            case X:
                adjustedPositionVector =
                        new Vec3(portalBlockPos.getX() + portalCenterC, portalBlockPos.getY() + portalCenterB,
                                portalBlockPos.getZ() + portalCenterA);
                break;
            case Y:
                adjustedPositionVector =
                        new Vec3(portalBlockPos.getX() + portalCenterA, portalBlockPos.getY() + portalCenterB,
