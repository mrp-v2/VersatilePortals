...
public class WorldUtil
{
    ...
    private static final List<PropertyParameter<?>> propertyParameters =
            Lists.newArrayList(new PropertyParameter.ValuesOrMissing<>(BlockStateProperties.PERSISTENT, true, true),
    ...
    private static final List<Class<?>> invalidBlockSupertypes =
            Lists.newArrayList(IPlantable.class, AbstractPlantBlock.class, AbstractButtonBlock.class,
                    AbstractCoralPlantBlock.class, AbstractRailBlock.class, AirBlock.class, AnvilBlock.class,
                    BambooBlock.class, BambooSaplingBlock.class, CarpetBlock.class, ChainBlock.class,
                    ChorusFlowerBlock.class, ChorusPlantBlock.class, CocoaBlock.class, DoorBlock.class,
                    DragonEggBlock.class, EndPortalFrameBlock.class, EndRodBlock.class, FarmlandBlock.class,
                    FenceBlock.class, FenceGateBlock.class, FireBlock.class, FlowerPotBlock.class,
                    FrostedIceBlock.class, LadderBlock.class, LanternBlock.class, LeverBlock.class,
                    NetherPortalBlock.class, ObserverBlock.class, PaneBlock.class, PistonHeadBlock.class,
                    PressurePlateBlock.class, WallBlock.class, WebBlock.class, WeightedPressurePlateBlock.class,
                    RedstoneDiodeBlock.class, RedstoneTorchBlock.class, RedstoneWireBlock.class, SnowBlock.class,
                    SoulFireBlock.class, StructureVoidBlock.class, TorchBlock.class, TripWireBlock.class,
                    TripWireHookBlock.class, TurtleEggBlock.class, VineBlock.class);
    private static final List<Function<Block, Boolean>> blockValidityCheckers = Lists.newArrayList(block ->
    {
    ...
    private static final List<Function<BlockState, Boolean>> blockStateValidityCheckers =
            Lists.newArrayList(blockState -> !blockState.hasTileEntity(),
                    blockState -> blockState.getFluidState().isEmpty(), blockState ->
                    {
    ...
    public static void init()
    {
        ...
        {
            addInvalidBlocks(Blocks.BARRIER, Blocks.BEDROCK);
            addPropertyParameters(
                    new PropertyParameter.ValuesOrMissing<>(BlockStateProperties.BITES_0_6, Util.makeArray(Blocks.CAKE),
                            true, 0),
                    new PropertyParameter.ValuesOrMissing<>(BlockStateProperties.NOTE_BLOCK_INSTRUMENT,
                            Util.makeArray(Blocks.NOTE_BLOCK), true, NoteBlockInstrument.HARP),
                    new PropertyParameter.ValuesOrMissing<>(BlockStateProperties.EXTENDED,
                            Util.makeArray(Blocks.PISTON, Blocks.STICKY_PISTON), true, false),
                    new PropertyParameter.ValuesOrMissing<>(BlockStateProperties.BOTTOM,
                            Util.makeArray(Blocks.SCAFFOLDING), true, false),
    ...
    public static void addPropertyParameters(PropertyParameter<?>... parameter)
    {
        WorldUtil.propertyParameters.addAll(Arrays.asList(parameter));
    }
     ...
     */
    @SafeVarargs public static void addBlockValidityCheckers(Function<Block, Boolean>... blockValidityCheckers)
    {
     ...
     */
    @SafeVarargs public static void addBlockStateValidityCheckers(
            Function<BlockState, Boolean>... blockStateValidityCheckers)
    {
